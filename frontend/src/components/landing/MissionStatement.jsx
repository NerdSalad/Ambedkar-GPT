...
// Mission Statement — two-column: copy + framed Jay Bhim / Ambedkar poster
export default function MissionStatement({
  ...
  const copy = (
    <div className="flex-1">
      {/* Label pill — rectangular, left-aligned per design */}
      ...
      <p className="mt-6 max-w-[520px] text-[15px] leading-[1.8] text-[#aec0de]">
        {description}
      </p>

      <div className="mt-8 grid max-w-[480px] grid-cols-1 gap-4 sm:grid-cols-2">

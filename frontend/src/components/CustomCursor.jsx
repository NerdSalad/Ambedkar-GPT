...
// Both elements render at a high z-index and are pointer-events:none.
// We guard with (pointer: fine) so touch devices don't mount the RAF loop.
export default function CustomCursor() {
  const outlineRef = useRef(null);
  const dotRef     = useRef(null);

  // live pointer position + eased position for the ring

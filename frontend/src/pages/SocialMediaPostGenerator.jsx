...
export default function SocialMediaPostGenerator() {
  ...
  return (
    ...
    >
      {/* ambient glows */}
      <div className="pointer-events-none absolute top-0 right-0 h-[500px] w-[500px] rounded-full bg-[#3f9fff]/10 blur-[140px]" />
      <div className="pointer-events-none absolute bottom-0 -left-32 h-[420px] w-[420px] rounded-full bg-[#7b5cff]/10 blur-[140px]" />
      ...
      {/* Hero */}
      <div className="relative z-10 mx-auto max-w-[1280px] px-6 md:px-10 pt-8 text-center">
        <h1 className="font-display text-[40px] md:text-[52px] font-bold leading-[1.05] tracking-tight">
      ...
      {/* 3-col layout */}
      <main className="relative z-10 mx-auto grid max-w-[1280px] gap-5 px-6 md:px-10 pb-16 pt-10 lg:grid-cols-12">
        {/* ── Left: form ── */}
